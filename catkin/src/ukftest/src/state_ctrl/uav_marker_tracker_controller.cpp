...
* All rights reserved.
*
* File:	uav_marker_track_controller.cpp
* Brief:  
* Version: 1.0
* Author: YING Jiahang
* Email: yingjiahang@gmail.com
* Date:	2014/8/21 22:00
* History: 
************************************************************************/
// ros
#include "ros/ros.h"
...
int main (int argc, char** argv)
{
	...
	ros::init(argc, argv, "uav_track_controller_node");
	ros::NodeHandle nh;
	...
	ctrlpub = nh.advertise<geometry_msgs::Quaternion>("track_ctrl",10);
...
void ukfCallback(const ukftest::ukfData& ukf)
{
	...
	if(ukf.isctrl ==1)
	{
		...
		*/
		...
		controlInput[2] = 0;                        //body z , vel
		controlInput[3] = 0;   			// yaw control
	...
	else
	{
		...
		outMsg.isCtrl = 0;
		outMsg.ctrl.z = 0;         //yaw_rate  
		outMsg.ctrl.x = 0;         //pitch
		outMsg.ctrl.y = 0;         //roll
		outMsg.ctrl.w = 0;         //vel
		ctrlpub.publish(outMsg);
